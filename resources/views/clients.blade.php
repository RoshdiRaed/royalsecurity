...
<head>
    ...
    <title>Royal Security | Clients</title>
...
<body class="bg-gray-100 text-gray-900">
    ...
    <main class="ml-0 md:ml-64 pt-20 px-4 sm:px-6 lg:px-8 min-h-screen">
        <div class="max-w-7xl mx-auto">
            ...
            <section class="mb-8" data-aos="fade-up">
                ...
                <p class="text-gray-600">View and manage client information and contracts.</p>
            </section>

            <!-- Add Client Button -->
            <section class="mb-8" data-aos="fade-up">
                <button id="openAddClientModal" class="btn-primary bg-yellow-400 text-gray-900 px-6 py-3 rounded-full font-semibold hover:bg-yellow-500">Add New Client</button>
            </section>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-800">Client Name</th>
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-800">Contact</th>
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-800">Service</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">Ahmed Khalil</td>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">Sara Mahmoud</td>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">Omar Saleh</td>
                                <td class="px-6 py-4 text-sm text-gray-600">Construction Site Security</td>
                                <td class="px-6 py-4 text-sm text-green-600">Active</td>
                                <td class="px-6 py-4 text-sm">
                                    <a href="#" class="text-yellow-400 hover:text-yellow-500 mr-4">View</a>
                                    <a href="#" class="text-red-600 hover:text-red-700">Delete</a>
            ...
            <!-- Add Client Modal -->
            <div id="addClientModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden flex items-center justify-center" data-aos="zoom-in">
                <div class="bg-white rounded-xl p-6 w-full max-w-md">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Add New Client</h2>
                    <form>
                        <div class="mb-4">
                            <label class="block text-sm font-semibold text-gray-600 mb-2" for="clientName">Client Name</label>
                            <input id="clientName" type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-yellow-400 focus:border-yellow-400" required>
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-semibold text-gray-600 mb-2" for="contactName">Contact Name</label>
                            <input id="contactName" type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-yellow-400 focus:border-yellow-400" required>
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-semibold text-gray-600 mb-2" for="service">Service</label>
                            <select id="service" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-yellow-400 focus:border-yellow-400">
                                <option value="comprehensive">Comprehensive Security</option>
                                <option value="vip">VIP Protection</option>
                                <option value="event">Event Security</option>
                            </select>
                        </div>
                        <div class="flex justify-end space-x-4">
                            <button type="button" id="closeAddClientModal" class="px-4 py-2 text-gray-600 hover:text-gray-800">Cancel</button>
    ...
    <script>
        ...
        openAddClientModal.addEventListener('click', () => {
        ...
        document.querySelector('form').addEventListener('submit', (e) => {
            e.preventDefault();
            alert('Client saved! (Placeholder)');
            addClientModal.classList.add('hidden');
        });
    </script>
</body>
