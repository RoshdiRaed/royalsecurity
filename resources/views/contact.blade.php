                ...
                <div class="bg-gray-50 p-8 rounded-xl shadow-lg card-hover">
                    ...
                    <ul class="space-y-4 text-gray-600">
                        <li class="flex items-start">
                            ...
                            <span data-en="Gaza Strip, Palestine" data-ar="قطاع غزة، فلسطين">Gaza Strip, Palestine</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-yellow-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            <a href="tel:+970-59-999999" class="hover:text-yellow-400"><span dir="ltr">059999999</span></a>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-yellow-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                            </svg>
                            <a href="mailto:info@royalsecurity.ps" class="hover:text-yellow-400">info@royalsecurity.ps</a>
                        </li>
                    </ul>
                </div>
                <div class="bg-gray-50 p-8 rounded-xl shadow-lg card-hover">
                    ...
                    <div class="h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                        <p class="text-gray-500" data-en="Interactive Map Placeholder (Embed Google Maps or similar here)" data-ar="عنصر نائب للخريطة التفاعلية (قم بتضمين خرائط جوجل أو ما شابه هنا)">Interactive Map Placeholder (Embed Google Maps or similar here)</p>
                    </div>
                </div>
            </div>
        </div>
